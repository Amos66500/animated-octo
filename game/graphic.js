function init()
{
    ...
    enemy1 = new Enemy("enemy1", 0xffffff, new THREE.Vector2(0, 0), Math.PI);
    ...
    for (x = minX; x <= maxX; x = x+sizeOfTileX){
        for (y = minY; y <= maxY; y = y+sizeOfTileY){
            ...
            if (color != 0x000000)
            {
                ...
                new THREE.PlaneGeometry(sizeOfTileX, sizeOfTileY),
...
{
    pointLight = new THREE.PointLight(color, 200, 0);
